...
use graphrox::matrix::{CsrMatrix, Matrix};
...
fn main() {
    ...
    matrix.add_entry(106531u64, 6, 5);
    matrix.add_entry(4, 2, 3);
    matrix.add_entry(10, 4, 1);
    matrix.add_entry(10, 0, 3);
    matrix.add_entry(1, 7, 2);
    matrix.add_entry(12, 5, 0);
